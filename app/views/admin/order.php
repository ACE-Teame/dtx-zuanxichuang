                        ...
                        <tbody>
                            <?php foreach ($orderData as $key => $order): ?>
                                <tr>
                                    ...
                                    <td><?php echo $order['loan_term'] ?></td>
                                    <td><?php echo $order['address'] ?></td>
                                    <td><?php echo $order['occupation'] ?></td>
                                    <td><?php echo $order['social_security'] ? '有' : '无'; ?></td>
                                    <td><?php echo $order['accumulation_fund'] ? '有' : '无'; ?></td>
                                    <td><?php echo $degreeList[$order['degree']] ?></td>
